...
const navItems = [
  ...
  { href: "/controle-center/seo", label: "SEO", icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z", permission: "settings" },
  { href: "/controle-center/performance", label: "Performance", icon: "M13 10V3L4 14h7v7l9-11h-7z", permission: "settings" },
