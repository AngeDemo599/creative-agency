...
const serviceData = {
  ...
  description: "Nous développons des stratégies de contenu engageantes qui connectent votre marque avec votre audience. Gestion de communauté, création de contenu et campagnes publicitaires sur toutes les plateformes.",
  longDescription: "Les réseaux sociaux sont devenus essentiels pour toute stratégie de marque. Notre équipe de community managers et créateurs de contenu développe des stratégies personnalisées pour chaque plateforme. De la création de contenu à l'analyse des performances, nous vous accompagnons pour maximiser votre présence digitale et engager votre communauté.",
  features: [
...
const relatedProjects = [
  {
    ...
    description: "Campagne Instagram pour lancement de collection",
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&h=600&fit=crop",
    tags: ["Instagram", "Fashion", "Launch"],
  },
  {
    id: 2,
    title: "Food & Beverage",
    description: "Stratégie TikTok pour chaîne de restaurants",
    image: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=800&h=600&fit=crop",
    tags: ["TikTok", "Food", "Viral"],
  },
  {
    id: 3,
    title: "Tech Startup",
    description: "Stratégie LinkedIn B2B pour startup tech",
    image: "https://images.unsplash.com/photo-1551434678-e076c223a692?w=800&h=600&fit=crop",
    tags: ["LinkedIn", "B2B", "Tech"],
  },
  {
    id: 4,
    title: "Lifestyle Brand",
    description: "Campagne multi-plateforme pour marque lifestyle",
    image: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=800&h=600&fit=crop",
    tags: ["Multi-platform", "Lifestyle", "Content"],
  },
  {
    id: 5,
    title: "Event Promotion",
    description: "Promotion événement sur les réseaux sociaux",
    image: "https://images.unsplash.com/photo-1505373877841-8d25f7d46678?w=800&h=600&fit=crop",
    tags: ["Event", "Promotion", "Engagement"],
  },
];
      ...
      <section className="pt-12 pb-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 text-sm text-zinc-500 mb-8">
            ...
            <span>/</span>
            <span className="text-zinc-700">Social Media</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="mt-12 text-center">
            <Link
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-pink-600 text-white rounded-full font-semibold hover:bg-pink-700 transition-colors"
            >
              Voir tous les projets Social Media
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </Link>
