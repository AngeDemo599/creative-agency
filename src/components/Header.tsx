...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay - Covers everything when open */}
      {isMenuOpen && (
        <div
      ...
      {/* Mobile Menu Panel */}
      <div
        className={`lg:hidden fixed top-0 left-0 bottom-0 w-[85%] max-w-[320px] bg-[#F7F3F1] z-[70] transform transition-transform duration-300 ease-out ${
          isMenuOpen ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        {/* Menu Header */}
        <div className="h-16 sm:h-20 flex items-center justify-between px-5 border-b border-gray-200">
        ...
        {/* Menu Content */}
        <div className="h-[calc(100%-4rem)] sm:h-[calc(100%-5rem)] overflow-y-auto">
          {/* Navigation Links */}
          ...
          <div className="px-5 py-4">
            <Link
              href="/contact"
              className="flex items-center justify-center gap-2 w-full py-4 bg-pink-600 text-white font-semibold rounded-2xl"
              onClick={() => setIsMenuOpen(false)}
            >
              Contactez-nous
              <svg className="w-5 h-5" viewBox="0 0 16 16" fill="none">
                <path d="M3.33 8h9.34" stroke="currentColor" strokeWidth="1.33" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M8 3.33L12.67 8 8 12.67" stroke="currentColor" strokeWidth="1.33" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </Link>
          </div>
          ...
          <div className="px-5 py-4 border-t border-gray-200">
            <p className="text-gray-500 text-sm mb-3">Contactez-nous</p>
            <a href="mailto:contact@newin.dz" className="block text-gray-700 text-sm mb-2">
              contact@newin.dz
            </a>
            <a href="tel:0770257785" className="block text-gray-700 text-sm">
              0770 25 77 85
            </a>
          </div>
          ...
          <div className="px-5 py-4 flex gap-3">
            <a href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500">
